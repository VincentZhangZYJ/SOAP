 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://ts.yujian/", wsdlLocation = "http://127.0.0.1:9876/ts?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://ts.yujian/", "TimeServerImplService");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://ts.yujian/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ts.yujian/", "TimeServerImplPort"), TimeServer.class, features);
    }

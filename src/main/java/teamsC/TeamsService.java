 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://team.yujian/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://team.yujian/", "TeamsService");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://team.yujian/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://team.yujian/", "TeamsPort"), Teams.class, features);
    }

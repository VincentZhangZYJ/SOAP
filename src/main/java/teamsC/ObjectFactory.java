...
public class ObjectFactory {
    ...
    private final static QName _GetTeamsResponse_QNAME = new QName("http://team.yujian/", "getTeamsResponse");
    private final static QName _GetTeam_QNAME = new QName("http://team.yujian/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://team.yujian/", "getTeams");
    private final static QName _GetTeamResponse_QNAME = new QName("http://team.yujian/", "getTeamResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.yujian/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.yujian/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.yujian/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://team.yujian/", name = "getTeamResponse")
